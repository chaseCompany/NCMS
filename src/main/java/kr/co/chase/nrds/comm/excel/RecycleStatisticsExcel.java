...
public class RecycleStatisticsExcel extends AbstractExcelView{
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook) throws Exception{
		...
		sheet.setColumnWidth(4, (short) (39*32));
		sheet.setColumnWidth(5, (short) (39*32));
		sheet.setColumnWidth(6, (short) (81*32));
		sheet.setColumnWidth(7, (short) (81*32));
		sheet.setColumnWidth(8, (short) (221*32));
		...
		sheet.setColumnWidth(17, (short) (221*32));
		...
		// 타이틀
		String[] titleArr = {"No", "기관명", "교육분류", "교육과정명", "회기", "차수", "주강사", "보조강사", "교육기간", "교육일시", "교육주제", "교육목표", "교육내용", "교육결과", "직원", "자원봉사자", "회원명", "진행기록"};
		...
		for(int i=0; i < cslInfo.size(); i++) {
			...
			this.cellStyleLoop(4, 4, contentCellStyle, row, cell, StringUtils.defaultIfEmpty((String)cslInfo.get(i).get("PGM_SESSION"), ""));
			this.cellStyleLoop(5, 5, contentCellStyle, row, cell, StringUtils.defaultIfEmpty((String)cslInfo.get(i).get("PGM_CLASS"), ""));
			this.cellStyleLoop(6, 6, contentCellStyle, row, cell, StringUtils.defaultIfEmpty((String)cslInfo.get(i).get("PGM_MAIN_LEC"), ""));
			this.cellStyleLoop(7, 7, contentCellStyle, row, cell, StringUtils.defaultIfEmpty((String)cslInfo.get(i).get("PGM_SUB_LEC"), ""));
			this.cellStyleLoop(8, 8, contentCellStyle, row, cell, 
			...
			this.cellStyleLoop(9, 9, contentCellStyle, row, cell,
			...
			this.cellStyleLoop(14, 14, contentCellStyle, row, cell, StringUtils.defaultIfEmpty((String)cslInfo.get(i).get("PGM_EMP"), ""));
			this.cellStyleLoop(15, 15, contentCellStyle, row, cell, StringUtils.defaultIfEmpty((String)cslInfo.get(i).get("PGM_VOL"), ""));
			this.cellStyleLoop(16, 16, contentCellStyle, row, cell, StringUtils.defaultIfEmpty((String)cslInfo.get(i).get("MBR_NM"), ""));
			this.cellStyleLoop(17, 17, contentCellStyle, row, cell, StringUtils.defaultIfEmpty((String)cslInfo.get(i).get("PGM_USER_CNT"), "").replaceAll("\r\n", "\n"));
		}
	}
