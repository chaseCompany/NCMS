...
public class EduMngExcel extends AbstractExcelView{
...
//		titleFont.setBoldweight(Font.BOLDWEIGHT_BOLD);							// 볼드(굵게)
		...
		this.cellStyleLoop(1, maxCellCount, titleCellStyle, row, cell, "교육관리");
		...
		row.setHeight((short) (26*15));
		this.cellStyleLoop(1, 1, basicLCellStyle, row, cell, "");
		this.cellStyleLoop(2, 2, basicCellStyle, row, cell, "교육일수");
		this.cellStyleLoop(3, 3, basicCellStyle, row, cell, StringUtils.defaultIfEmpty((String)cslInfo.get("PGM_DUR"), ""));
		this.cellStyleLoop(4, 4, basicCellStyle, row, cell, "교육시간");
		this.cellStyleLoop(5, 5, basicRCellStyle, row, cell, cslInfo.get("PGM_CLASS_DUR") == null ? "" : String.valueOf(cslInfo.get("PGM_CLASS_DUR")));
		rowCount++;
		row = sheet.createRow(rowCount);
		row.setHeight((short) (26*15));
		this.cellStyleLoop(1, 1, basicLCellStyle, row, cell, "");
