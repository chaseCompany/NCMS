...
//		sheet.addMergedRegion(new CellRangeAddress(rowCount, rowCount+3, 1, 1));
		...
		this.cellStyleLoop(3, 5, basicRCellStyle, row, cell, StringUtils.defaultIfEmpty((String)cslInfo.get("AST_SCO").toString(), ""));
		sheet.addMergedRegion(new CellRangeAddress(rowCount, rowCount, 3, 5));
		...
		if( !( "0".equals(cslInfo.get("RSKA_TP_CD")) && "0".equals(cslInfo.get("RSKB_TP_CD")) && "0".equals(cslInfo.get("RSKC_TP_CD"))
				&& ( "0".equals(cslInfo.get("RSK_SCO").toString()) || "".equals(StringUtils.defaultIfEmpty((String)cslInfo.get("RSK_SCO").toString(), "")) )
			...
			this.cellStyleLoop(3, 5, basicRCellStyle, row, cell, StringUtils.defaultIfEmpty((String)cslInfo.get("RSK_SCO").toString(), ""));
			sheet.addMergedRegion(new CellRangeAddress(rowCount, rowCount, 3, 5));
			rowCount++;
			row = sheet.createRow(rowCount);
			row.setHeight((short) (26*15));
