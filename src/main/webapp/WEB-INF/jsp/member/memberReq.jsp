...
<div class="top-right-btn">
	<button type="button" onclick="javaScript:transSave();" class="el-button normal el-button--primary el-button--small is-plain">
...
<c:if test="${reqServiceList ne null and reqServiceList ne ''}">
	...
	<c:forEach var="result" items="${reqServiceList}" varStatus="status">
						...
						<th>연계상태</th>
						<td>
<c:if test="${linkStateList ne null and linkStateList ne ''}">
