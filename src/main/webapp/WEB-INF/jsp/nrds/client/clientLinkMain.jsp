					...
					<div class="el-card_body">
						<table class="w-auto wr-form">
							<tbody>
								<tr>
									<th>연계기관</th>
									<td><input type="text" class="el-input__inner" placeholder="연계기관" style="width: 130px;" /></td>
									<th>연계자</th>
									<td><input type="text" class="el-input__inner" placeholder="연계자" style="width: 130px;" /></td>
									<th>연락처</th>
									<td><input type="text" class="el-input__inner" placeholder="연락처" style="width: 130px;" /></td>
								</tr>
								<tr>
									<th>등록지시일</th>
