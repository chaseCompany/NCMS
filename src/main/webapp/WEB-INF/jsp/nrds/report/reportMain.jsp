	...
	$(document).ready(function(){
		...
		statisticsExcel = function(_obj, _name){
			if($("input[name='fmDt']").val() != "" && $("input[name='toDt']").val() != ""){
				...
				$("form#excelForm").attr("action", "/nrds/statisticsExcelDownload.do");
...
<div class="formline">
	...
	<div class="section">
		<ul class="file-down-list">
			<li>
				<button onclick="javaScript:statisticsExcel(this, 'RecycleStatisticsExcel');" type="button" class="el-button el-button--primary el-button--medium is-plain" style="padding: 15px 21px 14px;">
					<i class="el-icon-document"></i><span>재활교육프로그램 통계</span>
				</button>
			</li>
			<li>
				<button onclick="javaScript:statisticsExcel(this, 'EduCounselStatisticsExcel');" type="button" class="el-button el-button--primary el-button--medium is-plain" style="padding: 15px 21px 14px;">
					<i class="el-icon-document"></i><span>교육상담 통계</span>
				</button>
			</li>
			<li>
